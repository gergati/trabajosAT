...
export const EditarForm = () => {
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        createWork(values, session!.user.id)
    }
    return (
        <Card className="m-auto w-[90%] md:w-[70%] bg-[#EDF7F5] dark:bg-[#020817]">
            <CardHeader>
                <CardTitle>Edite su busqueda de profesional</CardTitle>
                <CardDescription>Cambie los datos.</CardDescription>
            </CardHeader>
            <CardContent>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        <div className="grid md:grid-cols-2 grid-cols-1 m-auto justify-center gap-4">
                            ...
                            <div className="flex justify-center gap-4 flex-col md:flex-col">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem className="w-full">
                                            {/* <FormLabel>La obra social es...</FormLabel> */}
                                            <FormControl>
                                                <RadioGroup
                                                    onValueChange={field.onChange}
                                                    defaultValue={field.value}
                                ...
                                render={({ field }) => (
                                    <FormItem className="flex flex-row items-start space-x-3 space-y-0 ">
                                        ...
                                        <div className="space-y-1 leading-none">
                                            <FormLabel>
                                                Hé leido los <Link className="underline" href='/terminos'>términos y condiciones</Link>.
                                            </FormLabel>
                                        </div>
                                        <FormMessage />
                                    </FormItem>
                        ...
                        <Button className="w-full bg-gradient-to-r from-sky-400 to-blue-500 dark:from-sky-500 dark:to-blue-600 dark:text-white dark:hover:from-sky-600 dark:hover:to-blue-700" type="submit">Guardar cambios</Button>
                    </form>
                </Form>
            </CardContent>
        </Card>
